    ...
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-[#64748b]">Location: {loc || "Global"}</p>
        </div>
      ...
      {loading && (
        <div className="py-8 text-center">
          ...
          <div className="text-sm text-[#64748b]">Computing comparison…</div>
        </div>
      )}
                ...
                <tbody>
                  ...
                  {diff.removed.map((serial) => (
                    ...
                    >
                      ...
                      <td className="px-3 py-2">Absent compared to previous</td>
                    </tr>
                  ))}
                </tbody>
              </table>
