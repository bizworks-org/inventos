      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="grid grid-cols-1 gap-6">
          <div className="space-y-6">
            ...
            {/* Profile: IT & Security */}
            {activeTab === 'it' && (
              <motion.div id="panel-it" role="tabpanel" aria-labelledby="tab-it" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.2 }} className="bg-white rounded-2xl border border-[rgba(0,0,0,0.08)] p-6 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <FileDropzone
                      ...
                      uploadFile={async (file, onProgress) => {
                        const { promise } = uploadWithProgress(`/api/vendors/${vendorId}/documents`, file, { type: 'information_security_policy' }, onProgress);
                        const j = await promise;
                        setFormDocs((d) => [{ id: j.id, type: 'information_security_policy', name: j.name, created_at: new Date().toISOString() }, ...d]);
                        toast.success('Document uploaded');
                      }}
                    />
                  </div>
                  ...
                  <div className="md:col-span-2">
                    ...
                    <FileDropzone
                      ...
                      multiple={false}
                      uploadFile={async (file, onProgress) => {
                        const { promise } = uploadWithProgress(`/api/vendors/${vendorId}/documents`, file, { type: 'oem_authorization' }, onProgress);
                        const j = await promise;
                        setFormDocs((d) => [{ id: j.id, type: 'oem_authorization', name: j.name, created_at: new Date().toISOString() }, ...d]);
                        toast.success('Document uploaded');
                      }}
                    />
                  </div>
            ...
            {activeTab === 'performance' && (
              <motion.div id="panel-performance" role="tabpanel" aria-labelledby="tab-performance" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.3 }} className="bg-white rounded-2xl border border-[rgba(0,0,0,0.08)] p-6 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <FileDropzone id="dropzone-escalation_matrix" accept="application/pdf,image/*" multiple={false} uploadFile={async (file, onProgress) => {
                      const { promise } = uploadWithProgress(`/api/vendors/${vendorId}/documents`, file, { type: 'escalation_matrix' }, onProgress);
                      const j = await promise;
                      setFormDocs((d) => [{ id: j.id, type: 'escalation_matrix', name: j.name, created_at: new Date().toISOString() }, ...d]);
                      toast.success('Document uploaded');
                    }} />
                  </div>
                </div>
            ...
            {activeTab === 'procurement' && (
              <motion.div id="panel-procurement" role="tabpanel" aria-labelledby="tab-procurement" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.35 }} className="bg-white rounded-2xl border border-[rgba(0,0,0,0.08)] p-6 shadow-sm">
                    ...
                    <div key={docDef.key} className="p-3 border rounded-lg bg-[#fbfbff]">
                      ...
                      <div className="flex items-center gap-2">
                        <FileDropzone
                          ...
                          onFilesAdded={(arr) => {
                            if (docDef.multiple) arr.forEach((f) => uploadDocument(docDef.key, f));
            ...
            {activeTab === 'financial' && (
              <motion.div id="panel-financial" role="tabpanel" aria-labelledby="tab-financial" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.15 }} className="bg-white rounded-2xl border border-[rgba(0,0,0,0.08)] p-6 shadow-sm">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="flex items-center gap-2">
                      <FileDropzone
                        ...
                        multiple={false}
                        uploadFile={async (file, onProgress) => {
                          const { promise } = uploadWithProgress(`/api/vendors/${vendorId}/gst-certificate`, file, {}, onProgress);
                          await promise;
                          toast.success('GST certificate uploaded');
                          setFormData((p: any) => ({ ...p, gstCertificateName: file.name }));
                        }}
                      />
            ...
            {activeTab === 'contract' && (
              <motion.div id="panel-contract" role="tabpanel" aria-labelledby="tab-contract" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.1 }} className="bg-white rounded-2xl border border-[rgba(0,0,0,0.08)] p-6 shadow-sm">
            ...
            {activeTab === 'custom' && (
              <motion.div id="panel-custom" role="tabpanel" aria-labelledby="tab-custom" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.25 }} className="bg-white rounded-2xl border border-[rgba(0,0,0,0.08)] p-6 shadow-sm">
