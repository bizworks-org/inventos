        ...
        <div>
          <p className="font-medium text-[#1a1d2e] flex items-center gap-2">
            ...
            {isConnected && (
              <Badge
                variant="secondary"
                className="bg-[#e0f2f1] text-[#065f46] border-[#10b981]/20"
              >
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Enter credentials to authorize this integration.
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor={`endpoint-${integration.id}`}>
            ...
            <DialogFooter className="mt-4">
              ...
              <Button
                ...
                onClick={() => {
                  onConnect(integration.id, apiKey, endpointUrl);
                  setOpen(false);
                  setApiKey("");
                  setEndpointUrl("");
                }}
