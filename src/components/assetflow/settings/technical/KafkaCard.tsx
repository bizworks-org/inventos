      ...
      <CardContent className="space-y-4">
        <div>
          ...
          <Input
            ...
            value={events.kafkaBrokers}
            onChange={(e) =>
              setEvents((v: any) => ({ ...v, kafkaBrokers: e.target.value }))
            }
          />
        </div>
        <div>
          ...
          <Input
            placeholder="assetflow.events"
            value={events.kafkaTopic}
            onChange={(e) =>
              setEvents((v: any) => ({ ...v, kafkaTopic: e.target.value }))
            }
          />
        </div>
        <div>
          ...
          <Input
            placeholder="assetflow-ui"
            value={events.kafkaClientId}
            onChange={(e) =>
              setEvents((v: any) => ({ ...v, kafkaClientId: e.target.value }))
            }
          />
        </div>
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              setEvents((v: any) => ({
                ...v,
                kafkaSaslMechanism: e.target.value as any,
              }))
            }
          >
        ...
        {events.kafkaSaslMechanism !== "none" && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Input
                value={events.kafkaUsername}
                onChange={(e) =>
                  setEvents((v: any) => ({
                    ...v,
                    kafkaUsername: e.target.value,
                  }))
                }
              />
            </div>
            <div>
              ...
              <Input
                type="password"
                value={events.kafkaPassword}
                onChange={(e) =>
                  setEvents((v: any) => ({
                    ...v,
                    kafkaPassword: e.target.value,
                  }))
                }
              />
            </div>
