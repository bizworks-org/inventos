...
export default function RestWebhookCard(props: {
  ...
  const { events, setEvents, headersError, setHeadersError, saveRestSettings } = props;
  return (
    <Card>
      <CardHeader>
      ...
      <CardContent className="space-y-4">
        <div>
          ...
          <Input placeholder="https://example.com/webhook" value={events.webhookUrl} onChange={(e) => setEvents((v: any) => ({ ...v, webhookUrl: e.target.value }))} />
        </div>
        <div>
          ...
          <select
            ...
            onChange={(e) => setEvents((v: any) => ({ ...v, webhookMethod: e.target.value as 'POST' | 'PUT' }))}
          >
        ...
        <div>
          ...
          <Input type="password" placeholder="Used to sign requests (e.g., HMAC)" value={events.webhookSecret} onChange={(e) => setEvents((v: any) => ({ ...v, webhookSecret: e.target.value }))} />
        </div>
      </CardContent>
