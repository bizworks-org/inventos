...
type Language = 'en' | 'hi' | 'ta' | 'te' | 'bn' | 'mr' | 'gu' | 'kn' | 'ml' | 'pa' | 'or' | 'as' | 'sa' | 'kok' | 'ur' | 'ar';

type Currency = 'USD' | 'EUR' | 'GBP' | 'INR' | 'JPY' | 'AUD' | 'CAD' | 'CNY' | 'SGD';
...
const allowedLanguages: Language[] = ['en','hi','ta','te','bn','mr','gu','kn','ml','pa','or','as','sa','kok','ur','ar'];

function getLocaleForLanguage(lang: Language): string {
  const map: Record<Language, string> = {
    en: 'en', hi: 'hi-IN', ta: 'ta-IN', te: 'te-IN', bn: 'bn-IN', mr: 'mr-IN', gu: 'gu-IN',
    kn: 'kn-IN', ml: 'ml-IN', pa: 'pa-IN', or: 'or-IN', as: 'as-IN', sa: 'sa-IN', kok: 'kok-IN', ur: 'ur-IN', ar: 'ar'
  };
  return map[lang] || 'en';
}
...
const translations: Record<Language, Record<string, string>> = {
  ...
  ta: {}, te: {}, bn: {}, mr: {}, gu: {}, kn: {}, ml: {}, pa: {}, or: {}, as: {}, sa: {}, kok: {}
};
...
export function PrefsProvider({ children }: { children: React.ReactNode }) {
  ...
  const currencySymbol = useMemo(() => getCurrencySymbolFor(locale, prefs.currency), [locale, prefs.currency]);
